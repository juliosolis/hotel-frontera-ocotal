            ...
            <div class="container">
                <div class="row">
                    <div class="pull-left pre-address-b"><p><i class="fa fa-map-marker"></i> Contiguo a Gasolinera Ramos
                            <!--, km 226 de la carretera Panamericana Norte, Ocotal, Nueva Segovia--></p></div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-10 col-sm-10">
                        ...
                        <div class="col-lg-4 col-sm-4">
                            <h6>CONTACTO</h6>
                            <ul class="footer-links">
                                <li><p><i class="fa fa-map-marker"></i>Contiguo a Gasolinera Ramos, km 226 de la carretera
                                        Panamericana Norte, Ocotal, Nueva Segovia.</p></li>
                                <li><p><i class="fa fa-phone"></i> <a href="tel:+50527322668">+505 2732-2668</a> / <a href="tel:+50527322669">2732-2669</a></p></li>
